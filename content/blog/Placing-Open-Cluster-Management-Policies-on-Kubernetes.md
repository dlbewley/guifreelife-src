...
Red Hat Advanced Cluster Management for Kubernetes implements the [Open Cluster Management][6] APIs for the deployment (placement) of both application resourcess and governance policies. 
